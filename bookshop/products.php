...
if(isset($_GET['c']) && isset($_GET['s'])){
    ...
    $sql_cat="CALL getCategory('{$_GET['s']}');";
 $sub_cat_qry = $conn->query("SELECT * FROM sub_categories where md5(id) = '{$_GET['s']}'");
    if($sub_cat_qry->num_rows > 0){
        ...
        $sql2_cat_qry="CALL getSubCat('{$_GET['c']}');";
    }
}
elseif(isset($_GET['c'])){
    $cat_qry = $conn->query("SELECT * FROM categories where md5(id) = '{$_GET['c']}'");
        ...
        <div class="<?php echo isset($_GET['c'])? 'col-md-9': 'col-md-10 offset-md-1' ?>">
            ...
            <div class="tab-content pt-2">
                <div class="tab-pane fade show active" id="book">
                    ...
                    <div class="row gx-2 gx-lg-2 row-cols-1 row-cols-md-6 row-cols-xl-5">
                        ...
                        ?>
                        <div class="col-md-12 mb-5 row mb-5">
                            <div class="card product-item">
                                ...
                                <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                    <div class="text-center">
                                        <a class="btn btn-outline-dark ml-2 "   href=".?p=view_product&id=<?php echo md5($row['id']) ?>">View</a>
                                    </div>
